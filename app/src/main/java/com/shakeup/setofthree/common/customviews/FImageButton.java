...
/**
 * Created by Jayson Dela Cruz on 7/27/2017.
 *
 * This is a modified class from the FButton library that subclasses ImageButton instead.
 * Nothing else needed to be changed and it works.
 */

public class FImageButton extends AppCompatImageButton implements View.OnTouchListener{
    ...
    public FImageButton(Context context) {
        super(context);
        init();
        this.setOnTouchListener(this);
    }

    public FImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    ...
    public FImageButton(Context context, AttributeSet attrs, int defStyle) {
